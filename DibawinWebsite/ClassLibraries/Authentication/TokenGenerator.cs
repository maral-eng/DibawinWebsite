...
using DibawinWebsite.ClassLibraries.SMSService.SMSIR;
using DibawinWebsite.Models.AdminViewModels;

namespace DibawinWebsite.ClassLibraries.Authentication
{
    public class TokenGenerator
    {
        ...
        public TokenGenerator(UserManager<ApplicationUser> userManager, MyDBContext db)
        {
